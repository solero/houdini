...
class Penguin(db.Model):
    ...
    character = db.Column(db.ForeignKey('character.id', ondelete='SET NULL', onupdate='CASCADE'))
    igloo = db.Column(db.ForeignKey('penguin_igloo_room.id', ondelete='SET NULL', onupdate='CASCADE'))
