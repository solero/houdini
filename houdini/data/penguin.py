...
class Penguin(db.Model):
    ...
    character = db.Column(db.ForeignKey('character.id', ondelete='SET NULL', onupdate='SET NULL'))
    igloo = db.Column(db.ForeignKey('penguin_igloo_room.id', ondelete='SET NULL', onupdate='SET NULL'))
    coins = db.Column(db.Integer, nullable=False, server_default=db.text("500"))
    color = db.Column(db.ForeignKey('item.id', ondelete='SET NULL', onupdate='CASCADE'))
    head = db.Column(db.ForeignKey('item.id', ondelete='SET NULL', onupdate='CASCADE'))
    face = db.Column(db.ForeignKey('item.id', ondelete='SET NULL', onupdate='CASCADE'))
    neck = db.Column(db.ForeignKey('item.id', ondelete='SET NULL', onupdate='CASCADE'))
    body = db.Column(db.ForeignKey('item.id', ondelete='SET NULL', onupdate='CASCADE'))
    hand = db.Column(db.ForeignKey('item.id', ondelete='SET NULL', onupdate='CASCADE'))
    feet = db.Column(db.ForeignKey('item.id', ondelete='SET NULL', onupdate='CASCADE'))
    photo = db.Column(db.ForeignKey('item.id', ondelete='SET NULL', onupdate='CASCADE'))
    flag = db.Column(db.ForeignKey('item.id', ondelete='SET NULL', onupdate='CASCADE'))
